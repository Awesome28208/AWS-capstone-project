...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cw9m6eqtcmk2.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awesome-blog' # please enter your s3 bucket name
